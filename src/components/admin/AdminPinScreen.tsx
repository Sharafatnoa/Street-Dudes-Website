/**
 * PIN entry screen for admin dashboard authentication.
 * Compares PIN server-side via POST /api/admin/auth without exposing ADMIN_PIN to client.
 */
...
export function AdminPinScreen({ onSuccess }: AdminPinScreenProps) {
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="bg-[#141414] border border-white/10 p-6 md:p-8 rounded-xl max-w-sm w-full space-y-6 text-center shadow-2xl">
        <div>
          ...
          <p className="text-xs text-white/50 mt-1">Ange PIN-kod för adminpanelen</p>
        </div>
